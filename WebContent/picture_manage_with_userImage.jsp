...
<!-- 	            <button class="btn btn-primary" id="emp_add_modal_btn">新增</button>
 ...
 -->	        </div>
				...
				<table class="table table-hover" id="rough_table">
					<thead>
				  	...
				  	<colgroup>
					    ...
					    <col width='30%'></col> <!--用户ID -->
					    <col width='30%'></col><!-- 用户昵称 -->
					    <col width='25%'></col><!-- 查看图片 -->
					    <col width='10%'></col><!-- 修改 -->
					    <col width='10%'></col><!-- 删除 -->
				   </colgroup>
					<thead>
				...
				.each(
						...
						function(index, item) {
							...
							$("<tr></tr>").append(checkboxTd).append(
									userIdTD).append(userNameTD).append(shootingTimeTD)
	...
	function get_job_by_key() {
		...
		$.ajax({
			url : "/Picture_SpringMvc/picture/get_by_key_with_userName",
