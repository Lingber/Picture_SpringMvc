 ...
 %>
  ...
  <body class="login">
          ...
          <section class="login_content">
            ...
            <form id="login_form" name="login">
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> 拍照识物品</h1>
                  <p>©2018  版权所有 @周巧</p>
                </div>
              </div>
            </form>
	...
	function getSMScode(){
		...
		$.ajax({
			url : "/Picture_SpringMvc/register/sms",
    ...
    $("#login_btn").click(function () {
        ...
        //发送Ajax请求
        $.ajax({
            url:"/Picture_SpringMvc/login/loginCheckUp",
            type:"POST",
    ...
    $("#register_btn").click(function () {
        ...
        //发送Ajax请求
        $.ajax({
            url:"/Picture_SpringMvc/register/register_request",
            type:"POST",
