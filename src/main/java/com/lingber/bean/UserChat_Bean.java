...
* @version 创建时间：2018年5月22日 上午11:05:24 
* 类说明 :
*/
public class UserChat_Bean {
	...
	public UserChat_Bean(String receiverID, String senderID, String chatContent, URL picURL, String chatClass,
			String chatTime, String senderName, URL senderURL, String picture_Name) {
		super();
		this.receiverID = receiverID;
		this.senderID = senderID;
		this.chatContent = chatContent;
